 ...
 * ActivityHomeIconGoodsMapper.java
...
public interface ActivityHomeIconGoodsMapper extends IBaseMapper {
	 ...
	 * @date 2016年12月28日
	 */
	List<ActivityHomeIconGoods> findListByHomeIconId(String homeIconId);
	 ...
	 * @date 2016年12月28日
	 */
	int insertMore(@Param("list") List<ActivityHomeIconGoods> list);
}