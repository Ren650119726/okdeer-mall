...
import com.yschome.api.mall.order.dto.ERPTradeOrderVoDto;
import com.yschome.api.mall.order.dto.TradeOrderDto;
import com.yschome.api.mall.order.dto.TradeOrderInvoiceDto;
import com.yschome.api.mall.order.dto.TradeOrderItemDetailDto;
import com.yschome.api.mall.order.dto.TradeOrderItemDto;
import com.yschome.api.mall.order.dto.TradeOrderLogisticsDto;
import com.yschome.api.mall.order.dto.TradeOrderPayDto;
import com.yschome.api.mall.order.dto.TradeOrderPayQueryDto;
import com.yschome.api.mall.order.dto.TradeOrderQueryDto;
import com.yschome.api.mall.order.exception.ExceedRangeException;
import com.yschome.api.mall.order.service.ITradeOrderServiceApi;
 ...
 */
@Service(version = "1.0.0", interfaceName = "com.yschome.api.mall.order.service.ITradeOrderServiceApi")
    ...
    public PageResultVo<ERPTradeOrderVoDto> findOrderByParams(Map<String, Object> params) throws Exception {
        ...
        for (ERPTradeOrderVo vo : page.getList()) {
            ...
            if (vo.getOrderResource() != null) {
            	if (vo.getOrderResource() == OrderResourceEnum.YSCAPP || vo.getOrderResource() == OrderResourceEnum.WECHAT) {
