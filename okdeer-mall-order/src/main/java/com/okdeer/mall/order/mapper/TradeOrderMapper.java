...
public interface TradeOrderMapper {
     ...
     * @return
     */
    int selectPaymentStatusCountByIds(@Param("ids") String[] ids,@Param("paymentStatus") PaymentStatusEnum paymentStatus);
     ...
     * @param id
     */
    void updateIsShowById(@Param("isShow")OrderIsShowEnum isShow,
            @Param("updateTime")Date updateTime,@Param("id")String id);
	...
	/**
 	 ...
 	 * @return
 	 */
 	public Map<String, Object> selectWindowTipOrderCounts(
